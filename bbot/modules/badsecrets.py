...
class badsecrets(BaseModule):
    ...
    deps_pip = [
        "badsecrets~=0.13.47; python_version < '3.10'",
        "badsecrets~=1.0.170; python_version >= '3.10'",
        "pyjwt<2.13; python_version >= '3.10'",
    ]
                ...
                for r in r_list:
                    if r["type"] == "SecretFound":
                        ...
                        if r["detecting_module"] == "Generic_JWT":
                            continue
                        # Non-vulnerable ASP.NET artifacts identify a technology,
                        # but are not useful findings by themselves.
