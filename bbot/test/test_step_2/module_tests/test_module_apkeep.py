...
class TestApkeep(ModuleTestBase):
    ...
    config_overrides = {"modules": {"apkeep": {"output_folder": str(bbot_test_dir / "test_apkeep_files")}}}
...
class TestApkeepDirectPlayStoreUrl(ModuleTestBase):
    ...
    config_overrides = {"modules": {"apkeep": {"output_folder": str(bbot_test_dir / "test_apkeep_direct_files")}}}
    apk_file = tempapkfile()
